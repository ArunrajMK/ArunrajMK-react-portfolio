...
<Button
            ...
            <div className="container">
                ...
                <div className="social-icons">
                    <a href="mailto:arunrajshanker6@gmail.com" target="_blank" rel="noopener noreferrer">
                        <SiGmail />
                        Email
                    </a>
                    <a href="https://github.com/ArunrajMK" target="_blank" rel="noopener noreferrer" >
                        <SiGithub />
                        GitHub
                    </a>
                    ...
                    <a href="https://drive.google.com/file/d/1lgiQom199RIgfKB7abPs0JXZ81B7ryx8/view?usp=sharing" target="_blank" rel="noopener noreferrer">
                        <HiDocumentText />
                        Resume
                    </a>
                </div>
